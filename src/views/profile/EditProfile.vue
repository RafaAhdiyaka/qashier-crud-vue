                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="update">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" v-model="profile.nama_resto"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" v-model="profile.alamat_resto"
                                    placeholder="Masukkan Alamat Resto">
                                <!-- <input type="number" class="form-control" v-model="profile.nomor_telepon" placeholder="Masukkan Nomor Telepon">
                                <input type="email" class="form-control" v-model="profile.email_resto" placeholder="Masukkan Email Resto"> -->
                                <!-- validation -->
                            ...
                            <div class="form-group">
                                ...
                                <!-- <input type="text" class="form-control" v-model="profile.alamat_resto" placeholder="Masukkan Alamat Resto">
                                 -->
                                <input type="number" class="form-control" v-model="profile.nomor_telepon"
                            ...
                            <div class="form-group">
                                ...
                                <!-- <input type="text" class="form-control" v-model="profile.alamat_resto" placeholder="Masukkan Alamat Resto">
                                <input type="number" class="form-control" v-model="profile.nomor_telepon" placeholder="Masukkan Nomor Telepon"> -->
                                <input type="email" class="form-control" v-model="profile.email_resto"
                                    placeholder="Masukkan Email Resto">
                                <!-- validation -->
    ...
    export default {
        ...
        setup() {
            ...
            onMounted(() => {
                ...
                axios.get(`http://127.0.0.1:8000/api/profile-restaurants/${route.params.id}`)
                    .then(response => {

                        //assign state posts with response data
                        profile.nama_resto = response.data.data.nama_resto
                        profile.alamat_resto = response.data.data.alamat_resto
                        profile.nomor_telepon = response.data.data.nomor_telepon
                        profile.email_resto = response.data.data.email_resto
            ...
            function update() {
                ...
                axios.put(`http://127.0.0.1:8000/api/profile-restaurants/${route.params.id}`, {
