                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="update">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" v-model="menu.kategori_id" placeholder="Masukkan Judul Kategori">
                                <!-- validation -->
        ...
        onMounted(() => {
            ...
            .then(response => {
              //assign state posts with response data
                menu.nama_menu    = response.data.data.nama_menu  
                menu.deskripsi    = response.data.data.deskripsi  
                menu.harga    = response.data.data.harga  
                menu.kategori_id    = response.data.data.kategori_id  
